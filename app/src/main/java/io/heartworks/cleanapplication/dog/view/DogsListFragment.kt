...
import io.heartworks.cleanapplication.dog.data.DogsAdapter
import io.heartworks.cleanapplication.dog.injection.DaggerDogComponent
import io.heartworks.cleanapplication.dog.injection.DogComponent
import io.heartworks.cleanapplication.dog.injection.DogModule
 ...
 */
class DogsListFragment : CompositeFragment(), DogsListView {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    if (activity?.resources?.configuration?.orientation == Configuration.ORIENTATION_PORTRAIT) {
      ...
      dogs_recycler_view.addItemDecoration(
